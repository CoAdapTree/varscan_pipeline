...
#SBATCH --mem=8000M
#SBATCH --ntasks=1
#SBATCH --job-name=DF_pooled-DF_p77-indelRealign
#SBATCH --output=DF_pooled-DF_p77-indelRealign_%j.out 
...
java -Djava.io.tmpdir=$SLURM_TMPDIR -jar $EBROOTGATK/GenomeAnalysisTK.jar -T IndelRealigner -R /scratch/lindb/DF_2018_12_edit/DF_ref_edit.fasta -I /scratch/lindb/DF_pooled/DF_pooled/03_dedup_rg_filtered_indexed_sorted_bamfiles/DF_p77_rd.bam -targetIntervals /scratch/lindb/DF_pooled/DF_pooled/04_realign/DF_p77_realingment_targets.list -o /scratch/lindb/DF_pooled/DF_pooled/04_realign/DF_p77_realigned_reads.bam
module unload gatk
